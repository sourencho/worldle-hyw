...
export function Share({
  ...
  const shareText = useMemo(() => {
    ...
    const title = `#Մոլորիկ #${dayCount} ${guessCount}/6 ${bestPercent}${difficultyModifierEmoji}`;
    ...
    return ["https://molorig.xyz", title, "", guessString].join("\n");
  ...
  return (
    ...
    >
      <button className="rounded font-bold border-2 p-1 bg-green-600 hover:bg-green-500 active:bg-green-700 text-white w-full">
        {t("share")}
      </button>
    </CopyToClipboard>
  );
