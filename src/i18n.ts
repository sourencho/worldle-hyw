...
export const translations = {
  ...
  hyw: {
    translation: {
      placeholder: "Երկիր, երկրամաս...",
      guess: "Գուշակէ",
      share: "Բաժնէ",
      showOnGoogleMaps: "👀 Կուկըլ Քարտէսի վրայ",
      showOnWikipedia: "📚 Ուիքիի վրայ",
      welldone: "Շա՛տ ապրիս։",
      unknownCountry: "Չլսուած երկիր մըն է...",
      copy: "Արդիւնքդ վերցուցինք",
      showCountry: "🗺️ Քարտէսը ցոյց տուր։",
      cancelRotation: "🌀 Cancel rotation",
      settings: {
        title: "Նախընտրութիւններ",
        distanceUnit: "Հեռաւորութեան միաւոր",
        theme: "Թեմա",
        language: "Լեզու",
        difficultyModifiers: "Դիւրութեան մակարդակներ",
        startingNextDay: "Կը սկսինք յաջորդ օրը...",
        noImageMode: "Երկրին ուրուագիծը պահել յաւելեալ դժուարացնելու։",
        rotationMode: "Տեսնել երկրին ուրուագիծը ուրիշ կողմէ։",
        updateNotificationDisabled: "Մառել վերաթարմացման ազդակները։",
        showScale: "Մօտիկութեան տոկոսը փոխանակել չափի տոկոսով։",
      },
      stats: {
        title: "Վիճակագրութիւն",
        played: "Խաղցուած",
        win: "Յաղթելու %",
      ...
      install: {
        title: "Մոլորիկ",
        descritpionTitle: "Կիրը իջեցուր՝",
        description: "Մոլորիկը աւելցուր Մայր Էջիդ եւ դիւրապէս խաղցիր",
        instructionTitle: "Օրէնքներ՝:",
        instructionActionOk: "Օքէյ",
        instructionActionCancel: "Չեղեալ",
        instructionActionInstall: "Ներբեռնել",
        instructionFirefoxAction1: "- բաց նախընտրութիւններդ",
        instructionFirefoxAction2: "- աւելցուր Մայր Էջիդ",
        instructionFirefoxNewAction1: "- բաց նախընտրութիւններդ",
        instructionFirefoxNewAction2: "- ընտրէ՛ «Ներբեռնել»",
        instructionIdeviceAction1: "- Սաֆարիի վրայ, Բաժնելու ընտրութիւնը բաց",
        instructionIdeviceAction2: "- ընտրէ՛ «աւելցուր Մայր Էջիդ» տարբերակը",
        instructionOperaAction1: "- Կողէ ընտրացուցակին կոճակը",
        instructionOperaAction2: "- աւելցուր Մայր Էջիդ",
        instructionNotSupported: "Հոս խաղալ չես կրնար։",
      },
      support: {
        UA: "Support the Ukrainian Red Cross",
      },
      newVersion: "Նոր տարբերակ ունինք։",
      update: "Թարմացնել",
      or: "կամ",
      ignore: "Անտեսել",
      buyMeACoffee: "☕️ մը գնէ մեզի։",
      news: {
        newsNotifications: "Լրատուն աւելցած է։",
      },
    },
  },
  fr: {
